//=========================================================================
//
//  This file was generated by Mouse 1.9 at 2017-10-07 16:15:06 GMT
//  from grammar
...
public class WiktionaryParser extends wiktiopeggynary.parser.mouse.ParserBase
{
  ...
  //=====================================================================
  //  DeWortart = (WortartKopf WortartBody / UnknownWortartKopf
  //    (!KopfStart Line)*) ;
  //=====================================================================
  ...
  //-------------------------------------------------------------------
  //  DeWortart_1 = UnknownWortartKopf (!KopfStart Line)*
  //-------------------------------------------------------------------
  ...
  //-------------------------------------------------------------------
  //  DeWortart_2 = !KopfStart Line
  //-------------------------------------------------------------------
  private boolean DeWortart_2()
    {
      begin("");
      if (!DeWortart_3()) return rejectInner();
      if (!Line()) return rejectInner();
      return acceptInner();
    }
  
  //-------------------------------------------------------------------
  //  DeWortart_3 = !KopfStart
  //-------------------------------------------------------------------
  private boolean DeWortart_3()
    {
      begin("","not KopfStart");
  ...
  //=====================================================================
  //  Gender = LT GenderTemplateArgument "."? RT {Gender} ;
  //=====================================================================
  ...
  //    {GenderTemplateArgument_0} / [mnfu]+ {GenderTemplateArgument_1}
  //    ;
  //=====================================================================
  private boolean GenderTemplateArgument()
    {
      begin("GenderTemplateArgument");
      if (GenderTemplateArgument_0())
      { sem.GenderTemplateArgument_0(); return accept(); }
      if (GenderTemplateArgument_1())
      { sem.GenderTemplateArgument_1(); return accept(); }
      return reject();
    }
  
  //-------------------------------------------------------------------
  //  GenderTemplateArgument_0 = "fPl." / "mPl."
  //-------------------------------------------------------------------
  private boolean GenderTemplateArgument_0()
    {
      begin("");
      if (next("fPl.")) return acceptInner();
      if (next("mPl.")) return acceptInner();
      return rejectInner();
    }
  
  //-------------------------------------------------------------------
  //  GenderTemplateArgument_1 = [mnfu]+
  //-------------------------------------------------------------------
  private boolean GenderTemplateArgument_1()
    {
      begin("");
      if (!nextIn("mnfu")) return rejectInner();
      while (nextIn("mnfu"));
      return acceptInner();
    }
  
  //=====================================================================
  //  MiddleSection = (!KopfStart (FlexionTable / MeaningsTextbaustein /
  //    Line))* ;
  //=====================================================================
  ...
  //-------------------------------------------------------------------
  //  MiddleSection_0 = !KopfStart (FlexionTable / MeaningsTextbaustein
  //    / Line)
  //-------------------------------------------------------------------
  ...
  private boolean TranslationsSection_0()
    {
      begin("");
      if (!TranslationsSection_1()) return rejectInner();
      if (!Line()) return rejectInner();
      return acceptInner();
    }
  
  //-------------------------------------------------------------------
  //  TranslationsSection_1 = !TranslationsTableKopf
  //-------------------------------------------------------------------
  ...
  //=====================================================================
  //  Lang = LT ("pl" / "en" / "fr" / "it" / "es" / "ru") RT {Lang} ;
  //=====================================================================
  ...
  private boolean TranslationMeaning()
    {
      ...
      if (!TranslationMeaningBody()) return reject();
  ...
  //    {TranslationMeaningBody} ;
  //=====================================================================
  private boolean TranslationMeaningBody()
    {
      begin("TranslationMeaningBody");
      if (!TranslationMeaningBody_0()) return reject();
      while (TranslationMeaningBody_0());
      sem.TranslationMeaningBody();
      return accept();
    }
  
  //-------------------------------------------------------------------
  //  TranslationMeaningBody_0 = !ItemNo RichTextComponent
  //-------------------------------------------------------------------
  private boolean TranslationMeaningBody_0()
    {
      begin("");
      if (!TranslationMeaningBody_1()) return rejectInner();
      if (!RichTextComponent()) return rejectInner();
      return acceptInner();
    }
  
  //-------------------------------------------------------------------
  //  TranslationMeaningBody_1 = !ItemNo
  //-------------------------------------------------------------------
  private boolean TranslationMeaningBody_1()
    {
      begin("","not ItemNo");
      if (ItemNo()) return rejectPred();
      return acceptPred();
    }
  
  //=====================================================================
  //  UeTemplate = LT ("Ü?" / "Ü") SEP TParam SEP TParam (SEP TParam)?
  //    (SEP TParam)? RT {UeTemplate} ;
  //=====================================================================
  ...
  //    (SEP TParam)? (SEP TParam)? RT {UetTemplate} ;
  //=====================================================================
  ...
  //=====================================================================
  //  RichTextComponent = Link {RichTextComponent} / CursiveText
  //    {RichTextComponent} / Reference / Space QsTemplate Space /
  //    KTemplate {RichTextComponent} / AbkTemplate {RichTextComponent} /
  //    Gender {RichTextComponent} / WpTemplate {RichTextComponent} /
  //    (AeLangVariantTemplate / BeLangVariantTemplate)
  //    {RichTextComponent} / (UeTemplate / UetTemplate)
  //    {RichTextComponent} / UnknownTemplate / !EOL _
  //    {RichTextPlainText} ;
  //=====================================================================
  private boolean RichTextComponent()
    {
      ...
      if (Link())
      { sem.RichTextComponent(); return accept(); }
      if (CursiveText())
      { sem.RichTextComponent(); return accept(); }
      if (Reference()) return accept();
      if (RichTextComponent_0()) return accept();
      if (KTemplate())
      { sem.RichTextComponent(); return accept(); }
      if (AbkTemplate())
      { sem.RichTextComponent(); return accept(); }
      ...
      if (WpTemplate())
      { sem.RichTextComponent(); return accept(); }
      if (RichTextComponent_1())
      { sem.RichTextComponent(); return accept(); }
      if (RichTextComponent_2())
      { sem.RichTextComponent(); return accept(); }
      if (UnknownTemplate()) return accept();
      if (RichTextComponent_3())
      { sem.RichTextPlainText(); return accept(); }
      return reject();
    }
  
  //-------------------------------------------------------------------
  //  RichTextComponent_0 = Space QsTemplate Space
  //-------------------------------------------------------------------
  private boolean RichTextComponent_0()
    {
      begin("");
      Space();
      if (!QsTemplate()) return rejectInner();
      Space();
      return acceptInner();
    }
  
  //-------------------------------------------------------------------
  //  RichTextComponent_1 = AeLangVariantTemplate /
  //    BeLangVariantTemplate
  //-------------------------------------------------------------------
  private boolean RichTextComponent_1()
    {
      begin("");
      if (AeLangVariantTemplate()) return acceptInner();
      if (BeLangVariantTemplate()) return acceptInner();
      return rejectInner();
    }
  
  //-------------------------------------------------------------------
  //  RichTextComponent_2 = UeTemplate / UetTemplate
  //-------------------------------------------------------------------
  private boolean RichTextComponent_2()
    {
      begin("");
  ...
  //-------------------------------------------------------------------
  //  RichTextComponent_3 = !EOL _
  //-------------------------------------------------------------------
  private boolean RichTextComponent_3()
    {
      begin("");
      if (!RichTextComponent_4()) return rejectInner();
      if (!next()) return rejectInner();
      return acceptInner();
    }
  
  //-------------------------------------------------------------------
  //  RichTextComponent_4 = !EOL
  //-------------------------------------------------------------------
  private boolean RichTextComponent_4()
    {
      begin("","not EOL");
  ...
  //=====================================================================
  //  UnknownTemplate = LT TName (SEP TParam)* RT {UnknownTemplate} ;
  //=====================================================================
  private boolean UnknownTemplate()
    {
      begin("UnknownTemplate");
      if (!LT()) return reject();
  ...
  //=====================================================================
  //  TPosParam = (!(SEP / RT) RichTextComponent)* {TPosParam} ;
  //=====================================================================
  private boolean TPosParam()
    {
      begin("TPosParam");
      while (TParam_2());
      sem.TPosParam();
  ...
  //=====================================================================
  //  KTemplate = LT ("Kontext" / [Kk]) (SEP TParam)+ RT {KTemplate} ;
  //=====================================================================
  private boolean KTemplate()
    {
      begin("KTemplate");
      if (!LT()) return reject();
      if (!next("Kontext")
  ...
  //=====================================================================
  //  AbkTemplate = LT TName (SEP TParam)* RT {&AbkTemplate} ;
  //=====================================================================
  private boolean AbkTemplate()
    {
      begin("AbkTemplate");
      if (!LT()) return reject();
      if (!TName()) return reject();
      while (UeTemplate_0());
      if (!RT()) return reject();
      if (sem.AbkTemplate()) return accept();
      return reject();
    }
  ...
  //=====================================================================
  private boolean QsTemplate()
    {
      begin("QsTemplate");
      if (!LT()) return reject();
      if (!next("QS Bedeutungen")) return reject();
      while (QsTemplate_0());
      if (!RT()) return reject();
      return accept();
    }
  ...
  //-------------------------------------------------------------------
  //  QsTemplate_0 = SEP TPosParam
  //-------------------------------------------------------------------
  private boolean QsTemplate_0()
    {
      begin("");
      if (!SEP()) return rejectInner();
      TPosParam();
  ...
  //-------------------------------------------------------------------
  //  WpTemplate_0 = SEP TextualTParam
  //-------------------------------------------------------------------
  private boolean WpTemplate_0()
    {
      begin("");
      if (!SEP()) return rejectInner();
      if (!TextualTParam()) return rejectInner();
      return acceptInner();
    }
  
  //=====================================================================
  //  AeLangVariantTemplate = LT ("amer." / "AE") (SEP TextualTParam)? RT
  //    {AeLangVariantTemplate} ;
  //=====================================================================
  private boolean AeLangVariantTemplate()
    {
      begin("AeLangVariantTemplate");
      if (!LT()) return reject();
      if (!next("amer.")
       && !next("AE")
         ) return reject();
  ...
  //    {BeLangVariantTemplate} ;
  //=====================================================================
  private boolean BeLangVariantTemplate()
    {
      begin("BeLangVariantTemplate");
      if (!LT()) return reject();
      if (!next("brit.")
       && !next("BE")
         ) return reject();
      WpTemplate_0();
      if (!RT()) return reject();
      sem.BeLangVariantTemplate();
      return accept();
    }
  
  //=====================================================================
  //  ItemNo = "[" ItemNoBody "]" Space {ItemNo} ;
  //=====================================================================
  private boolean ItemNo()
    {
      begin("ItemNo");
      if (!next('[')) return reject();
      if (!ItemNoBody()) return reject();
      if (!next(']')) return reject();
      Space();
      sem.ItemNo();
      return accept();
  ...
  //=====================================================================
  //  ItemNoBody = ItemNoRange (COMMA ItemNoRange)* {ItemNoBody} ;
  //=====================================================================
  private boolean ItemNoBody()
    {
      begin("ItemNoBody");
      if (!ItemNoRange()) return reject();
      while (ItemNoBody_0());
      sem.ItemNoBody();
      return accept();
    }
  ...
  //-------------------------------------------------------------------
  //  ItemNoBody_0 = COMMA ItemNoRange
  //-------------------------------------------------------------------
  private boolean ItemNoBody_0()
    {
      begin("");
      if (!COMMA()) return rejectInner();
      if (!ItemNoRange()) return rejectInner();
      return acceptInner();
    }
  
  //=====================================================================
  //  ItemNoRange = (ItemNoElement "\u2013" ItemNoElement /
  //    ItemNoElement) {ItemNoRange} ;
  //=====================================================================
  private boolean ItemNoRange()
    {
      begin("ItemNoRange");
      if (!ItemNoRange_0()
       && !ItemNoElement()
  ...
  //-------------------------------------------------------------------
  //  ItemNoRange_0 = ItemNoElement "\u2013" ItemNoElement
  //-------------------------------------------------------------------
  private boolean ItemNoRange_0()
    {
      begin("");
      if (!ItemNoElement()) return rejectInner();
      if (!next('\u2013')) return rejectInner();
      if (!ItemNoElement()) return rejectInner();
      return acceptInner();
    }
  ...
  //=====================================================================
  private boolean ItemNoElement()
    {
      begin("ItemNoElement");
      if (!ItemNoElement_0()) return reject();
      while (ItemNoElement_0());
      return accept();
    }
  
  //-------------------------------------------------------------------
  //  ItemNoElement_0 = [a-z] / [0-9]
  //-------------------------------------------------------------------
  private boolean ItemNoElement_0()
    {
      begin("");
