//=========================================================================
//
//  This file was generated by Mouse 1.7 at 2017-09-26 20:40:47 GMT
//  from grammar
...
public class WiktionaryParser extends wiktiopeggynary.parser.mouse.ParserBase
{
  ...
  //    Template {RichTextTemplate} / !EOL _ {RichTextPlainText} ;
  //=====================================================================
  private boolean RichTextComponent()
    {
      ...
      if (Template())
      { sem.RichTextTemplate(); return accept(); }
  ...
  //-------------------------------------------------------------------
  //  RichTextComponent_1 = !EOL _
  //-------------------------------------------------------------------
  private boolean RichTextComponent_1()
    {
      begin("");
      if (!RichTextComponent_2()) return rejectInner();
      if (!next()) return rejectInner();
      return acceptInner();
    }
  
  //-------------------------------------------------------------------
  //  RichTextComponent_2 = !EOL
  //-------------------------------------------------------------------
  ...
  //=====================================================================
  //  Kontext = LT ("Kontext" / [Kk]) (SEP TParam)+ RT {Kontext} ;
  //=====================================================================
  ...
  //=====================================================================
  //  WpTemplate = LT "W" "P"? (SEP TextualTParam)+ RT {WpTemplate} ;
  //=====================================================================
  private boolean WpTemplate()
    {
      begin("WpTemplate");
      if (!LT()) return reject();
      if (!next('W')) return reject();
      next('P');
