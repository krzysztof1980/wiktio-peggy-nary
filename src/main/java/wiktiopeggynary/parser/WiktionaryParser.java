//=========================================================================
//
//  This file was generated by Mouse 1.6.1 at 2015-07-13 22:38:43 GMT
//  from grammar
...
public class WiktionaryParser extends wiktiopeggynary.parser.mouse.ParserBase
{
  ...
  //=====================================================================
  //  DeEintrag = DeSpracheKopf (WortartKopf MiddleSection
  //    TranslationsSection)+ ;
  //=====================================================================
  private boolean DeEintrag()
    {
      ...
      if (!DeEintrag_0()) return reject();
      while (DeEintrag_0());
      return accept();
    }
  
  //-------------------------------------------------------------------
  //  DeEintrag_0 = WortartKopf MiddleSection TranslationsSection
  //-------------------------------------------------------------------
  private boolean DeEintrag_0()
    {
      ...
      MiddleSection();
      if (!TranslationsSection()) return rejectInner();
      return acceptInner();
    }
  ...
  private boolean DeSpracheKopf()
    {
      ...
      if (!next("({{Sprache|Deutsch}})")) return reject();
      Space();
      if (!KOPF2()) return reject();
  ...
  //=====================================================================
  //  SubstantivKopf = KOPF3 "{{Wortart|Substantiv|Deutsch}}," Space
  //    Gender _*+ KOPF3 EOL {createSubstantiv} ;
  //=====================================================================
  private boolean SubstantivKopf()
    {
      begin("SubstantivKopf");
      if (!KOPF3()) return reject();
      if (!next("{{Wortart|Substantiv|Deutsch}},")) return reject();
      Space();
      if (!Gender()) return reject();
      while (!KOPF3())
  ...
  //=====================================================================
  //  FlexionTable = LT "Deutsch Substantiv Übersicht" Space EOL
  //    FlexionForm+ RT EOL ;
  //=====================================================================
  ...
  //    FlexionVariantList EOL {addNomSg} ;
  //=====================================================================
  ...
  //    FlexionVariantList EOL {addNomPl} ;
  //=====================================================================
  ...
  //    FlexionVariantList EOL {addGenSg} ;
  //=====================================================================
  ...
  //    FlexionVariantList EOL {addGenPl} ;
  //=====================================================================
  ...
  //    FlexionVariantList EOL {addDatSg} ;
  //=====================================================================
  ...
  //    FlexionVariantList EOL {addAkkSg} ;
  //=====================================================================
  ...
  //    FlexionVariantList EOL {addAkkPl} ;
  //=====================================================================
  ...
  //    / Space "\u2014" Space {absentFlexionForm} / (!EOL _)* ;
  //=====================================================================
  private boolean FlexionVariantList()
    {
      begin("FlexionVariantList");
      if (FlexionVariantList_0())
      { sem.flexionVariantList(); return accept(); }
      if (FlexionVariantList_1())
      { sem.absentFlexionForm(); return accept(); }
  ...
  //-------------------------------------------------------------------
  //  MiddleSection_0 = !TranslationsSection (FlexionTable / Line)
  //-------------------------------------------------------------------
  ...
  //-------------------------------------------------------------------
  //  MiddleSection_1 = !TranslationsSection
  //-------------------------------------------------------------------
  private boolean MiddleSection_1()
    {
      begin("","not TranslationsSection");
      if (TranslationsSection()) return rejectNot();
      return acceptNot();
    }
  
  //=====================================================================
  //  TranslationsSection = TranslationsKopf TranslationsTable (!KOPF2
  //    Line)* ;
  //=====================================================================
  ...
  //-------------------------------------------------------------------
  //  TranslationsSection_0 = !KOPF2 Line
  //-------------------------------------------------------------------
  ...
  //=====================================================================
  //  TranslationsTable = LT "Ü-Tabelle" Line (LangTranslations /
  //    DialectTable / !RT Line)*+ RT EOL ;
  //=====================================================================
  ...
  //    Space TranslationMeaning)* EOL {addTranslationsForLanguage} ;
  //=====================================================================
  ...
  //=====================================================================
  //  DialectTable = "|Dialekttabelle=" EOL (!RT Line)* ;
  //=====================================================================
