//=========================================================================
//
//  This file was generated by Mouse 1.6.1 at 2015-07-26 01:13:34 GMT
//  from grammar
...
public class WiktionaryParser extends wiktiopeggynary.parser.mouse.ParserBase
{
  ...
  //=====================================================================
  //  SubstantivKopf = KOPF3 SubstantivTemplate "," Space Gender _*+
  //    KOPF3 RestOfLine {createSubstantiv} ;
  //=====================================================================
  ...
  //=====================================================================
  //  TranslationsSection = TranslationsKopf (!TranslationsTable Line)*
  //    TranslationsTable (!KopfStart Line)* ;
  //=====================================================================
  ...
  //-------------------------------------------------------------------
  //  TranslationsSection_0 = !TranslationsTable Line
  //-------------------------------------------------------------------
  ...
  //-------------------------------------------------------------------
  //  TranslationsSection_2 = !TranslationsTable
  //-------------------------------------------------------------------
  private boolean TranslationsSection_2()
    {
      begin("","not TranslationsTable");
      if (TranslationsTable()) return rejectNot();
      return acceptNot();
    }
