//=========================================================================
//
//  This file was generated by Mouse 1.9 at 2017-10-07 09:02:10 GMT
//  from grammar
...
public class WiktionaryParser extends wiktiopeggynary.parser.mouse.ParserBase
{
  ...
  //=====================================================================
  //  RichTextComponent = Link {RichtTextLink} / CursiveText
  //    {RichTextCursiveText} / Reference / Space QsTemplate Space /
  //    KTemplate {RichTextKTemplate} / AbkTemplate {RichTextAbkTemplate}
  //    / Gender {RichTextGender} / WpTemplate {RichTextWpLink} /
  //    (UeTemplate / UetTemplate) {RichTextTranslation} /
  //    UnknownTemplate / !EOL _ {RichTextPlainText} ;
  //=====================================================================
  private boolean RichTextComponent()
    {
      begin("RichTextComponent");
      if (Link())
      { sem.RichtTextLink(); return accept(); }
      if (CursiveText())
      { sem.RichTextCursiveText(); return accept(); }
      if (Reference()) return accept();
      if (RichTextComponent_0()) return accept();
      if (KTemplate())
      { sem.RichTextKTemplate(); return accept(); }
      if (AbkTemplate())
      { sem.RichTextAbkTemplate(); return accept(); }
      if (Gender())
      { sem.RichTextGender(); return accept(); }
      if (WpTemplate())
      { sem.RichTextWpLink(); return accept(); }
      if (RichTextComponent_1())
      { sem.RichTextTranslation(); return accept(); }
  ...
  //-------------------------------------------------------------------
  //  RichTextComponent_1 = UeTemplate / UetTemplate
  //-------------------------------------------------------------------
  ...
  //-------------------------------------------------------------------
  //  RichTextComponent_2 = !EOL _
  //-------------------------------------------------------------------
  private boolean RichTextComponent_2()
    {
      begin("");
      if (!RichTextComponent_3()) return rejectInner();
      if (!next()) return rejectInner();
      return acceptInner();
    }
  
  //-------------------------------------------------------------------
  //  RichTextComponent_3 = !EOL
  //-------------------------------------------------------------------
