//=========================================================================
//
//  This file was generated by Mouse 1.7 at 2017-09-25 16:41:35 GMT
//  from grammar
...
public class WiktionaryParser extends wiktiopeggynary.parser.mouse.ParserBase
{
  ...
  //=====================================================================
  //  Meaning = MeaningLvl (ItemNo / "*") MeaningKontext Space
  //    RichTextComponent*+ EOL {Meaning} ;
  //=====================================================================
  ...
  //=====================================================================
  //  MeaningKontext = (Kontext / QsTemplate / AbkTemplate)?
  //    {MeaningKontext} ;
  //=====================================================================
  private boolean MeaningKontext()
    {
      begin("MeaningKontext");
      MeaningKontext_0();
      sem.MeaningKontext();
      return accept();
    }
  ...
  //-------------------------------------------------------------------
  //  MeaningKontext_0 = Kontext / QsTemplate / AbkTemplate
  //-------------------------------------------------------------------
  private boolean MeaningKontext_0()
    {
      begin("");
      if (Kontext()) return acceptInner();
      if (QsTemplate()) return acceptInner();
      if (AbkTemplate()) return acceptInner();
      return rejectInner();
    }
  ...
  //    {RichTextComponent_1} / !EOL _ {RichTextComponent_2} ;
  //=====================================================================
  ...
  private boolean TParam_2()
    {
      begin("");
      if (!TParam_3()) return rejectInner();
  ...
  private boolean TextualTParam()
    {
      begin("TextualTParam");
      if (!TextualTParam_0()) return reject();
      while (TextualTParam_0());
      return accept();
    }
  
  //-------------------------------------------------------------------
  //  TextualTParam_0 = !(SEP / RT) _
  //-------------------------------------------------------------------
  private boolean TextualTParam_0()
    {
      begin("");
      if (!TParam_3()) return rejectInner();
      if (!next()) return rejectInner();
  ...
  private boolean Kontext()
    {
      begin("Kontext");
      if (!LT()) return reject();
      if (!nextIn("Kk")) return reject();
      if (!KontextPartList()) return reject();
      KontextFtParam();
      KontextSprParam();
      if (!RT()) return reject();
      sem.Kontext();
  ...
  //=====================================================================
  //  KontextPartList = !(SEP "ft" EQ / SEP "spr" EQ) (SEP TPosParam
  //    KontextPartSep)+ {KontextPartList} ;
  //=====================================================================
  private boolean KontextPartList()
    {
      begin("KontextPartList");
      if (!KontextPartList_0()) return reject();
      if (!KontextPartList_1()) return reject();
      while (KontextPartList_1());
      sem.KontextPartList();
      return accept();
    }
  
  //-------------------------------------------------------------------
  //  KontextPartList_0 = !(SEP "ft" EQ / SEP "spr" EQ)
  //-------------------------------------------------------------------
  private boolean KontextPartList_0()
    {
      begin("","not SEP \"ft\" EQ / SEP \"spr\" EQ");
      if (KontextPartList_2()) return rejectPred();
      return acceptPred();
    }
  
  //-------------------------------------------------------------------
  //  KontextPartList_1 = SEP TPosParam KontextPartSep
  //-------------------------------------------------------------------
  private boolean KontextPartList_1()
    {
      begin("");
      if (!SEP()) return rejectInner();
      TPosParam();
  ...
  //-------------------------------------------------------------------
  //  KontextPartList_2 = SEP "ft" EQ / SEP "spr" EQ
  //-------------------------------------------------------------------
  private boolean KontextPartList_2()
    {
      begin("");
      if (KontextPartList_3()) return acceptInner();
      if (KontextPartList_4()) return acceptInner();
      return rejectInner();
    }
  
  //-------------------------------------------------------------------
  //  KontextPartList_3 = SEP "ft" EQ
  //-------------------------------------------------------------------
  private boolean KontextPartList_3()
    {
      begin("");
      if (!SEP()) return rejectInner();
      if (!next("ft")) return rejectInner();
      if (!EQ()) return rejectInner();
      return acceptInner();
    }
  
  //-------------------------------------------------------------------
  //  KontextPartList_4 = SEP "spr" EQ
  //-------------------------------------------------------------------
  private boolean KontextPartList_4()
    {
      begin("");
      if (!SEP()) return rejectInner();
      if (!next("spr")) return rejectInner();
      if (!EQ()) return rejectInner();
      return acceptInner();
    }
  
  //=====================================================================
  //  KontextPartSep = (SEP "t" [1-7] EQ [:;_])? {KontextPartSep} ;
  //=====================================================================
  private boolean KontextPartSep()
    {
      begin("KontextPartSep");
      KontextPartSep_0();
      sem.KontextPartSep();
      return accept();
    }
  ...
  //-------------------------------------------------------------------
  //  KontextPartSep_0 = SEP "t" [1-7] EQ [:;_]
  //-------------------------------------------------------------------
  private boolean KontextPartSep_0()
    {
      begin("");
      if (!SEP()) return rejectInner();
      if (!next('t')) return rejectInner();
      if (!nextIn('1','7')) return rejectInner();
      if (!EQ()) return rejectInner();
      if (!nextIn(":;_")) return rejectInner();
      return acceptInner();
    }
  ...
  //    {KontextFtParam} ;
  //=====================================================================
  private boolean KontextFtParam()
    {
      begin("KontextFtParam");
      KontextFtParam_0();
      sem.KontextFtParam();
      return accept();
    }
  ...
  //-------------------------------------------------------------------
  //  KontextFtParam_0 = SEP "ft" EQ (!(SEP / RT) RichTextComponent*)
  //-------------------------------------------------------------------
  private boolean KontextFtParam_0()
    {
      begin("");
      if (!SEP()) return rejectInner();
      if (!next("ft")) return rejectInner();
  ...
  //    ;
  //=====================================================================
  private boolean KontextSprParam()
    {
      begin("KontextSprParam");
      KontextSprParam_0();
      return accept();
    }
  
  //-------------------------------------------------------------------
  //  KontextSprParam_0 = SEP "spr" EQ (!(SEP / RT)
  //    RichTextComponent*)
  //-------------------------------------------------------------------
  private boolean KontextSprParam_0()
    {
      begin("");
      if (!SEP()) return rejectInner();
      if (!next("spr")) return rejectInner();
  ...
  //=====================================================================
  //  AbkTemplate = LT AbkTemplateName (SEP TParam)* RT {AbkTemplate} ;
  //=====================================================================
  private boolean AbkTemplate()
    {
      begin("AbkTemplate");
      if (!LT()) return reject();
      if (!AbkTemplateName()) return reject();
      while (UeTemplate_0());
      if (!RT()) return reject();
      sem.AbkTemplate();
      return accept();
  ...
  //=====================================================================
  private boolean AbkTemplateName()
    {
      begin("AbkTemplateName");
      if (!TextualTParam_0()) return reject();
      while (TextualTParam_0());
      return accept();
    }
