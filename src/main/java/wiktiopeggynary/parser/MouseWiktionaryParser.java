//=========================================================================
//
//  This file was generated by Mouse 1.7 at 2017-09-19 16:28:29 GMT
//  from grammar
...
public class MouseWiktionaryParser extends wiktiopeggynary.parser.mouse.ParserBase
{
  ...
  //=====================================================================
  //  Eintrag = DeEintrag? OtherLangEintrag* EOF / OldSpellingEintrag
  //    Line* EOF ;
  //=====================================================================
  ...
  //-------------------------------------------------------------------
  //  Eintrag_0 = DeEintrag? OtherLangEintrag* EOF
  //-------------------------------------------------------------------
  ...
  //=====================================================================
  //  OtherLangEintrag = !DeSpracheKopf SpracheKopf (!SpracheKopf Line)*
  //    ;
  //=====================================================================
  private boolean OtherLangEintrag()
    {
      ...
      if (!SpracheKopf()) return reject();
      while (OtherLangEintrag_1());
      return accept();
    }
  
  //-------------------------------------------------------------------
  //  OtherLangEintrag_0 = !DeSpracheKopf
  //-------------------------------------------------------------------
  private boolean OtherLangEintrag_0()
    {
      begin("","not DeSpracheKopf");
      if (DeSpracheKopf()) return rejectPred();
      return acceptPred();
    }
  
  //-------------------------------------------------------------------
  //  OtherLangEintrag_1 = !SpracheKopf Line
  //-------------------------------------------------------------------
  private boolean OtherLangEintrag_1()
    {
      begin("");
      if (!OtherLangEintrag_2()) return rejectInner();
      if (!Line()) return rejectInner();
      return acceptInner();
    }
  
  //-------------------------------------------------------------------
  //  OtherLangEintrag_2 = !SpracheKopf
  //-------------------------------------------------------------------
  private boolean OtherLangEintrag_2()
    {
      begin("","not SpracheKopf");
      if (SpracheKopf()) return rejectPred();
      return acceptPred();
    }
  ...
  //=====================================================================
  //  SpracheKopf = KOPF2 Lemma "(" LT "Sprache" SEP _++ RT ")" Space
  //    KOPF2 RestOfLine ;
  //=====================================================================
  private boolean SpracheKopf()
    {
      begin("SpracheKopf");
  ...
  //=====================================================================
  //  Genus = "Genus" (Space Digit)? "=" [mnfu0] EOL {addGenus} ;
  //=====================================================================
