//=========================================================================
//
//  This file was generated by Mouse 1.7 at 2017-09-19 14:47:05 GMT
//  from grammar
...
public class MouseWiktionaryParser extends wiktiopeggynary.parser.mouse.ParserBase
{
  ...
  //=====================================================================
  //  OldSpellingEintrag = DeSpracheKopf Line*+ OldSpellingTemplate EOL
  //    ;
  //=====================================================================
  ...
  //    Liechtensteiner Schreibweise") (SEP TextualTParam)+ RT
  //    {OldSpellingTemplate} ;
  //=====================================================================
  private boolean OldSpellingTemplate()
    {
      ...
      if (!OldSpellingTemplate_0()) return reject();
      while (OldSpellingTemplate_0());
      if (!RT()) return reject();
  ...
  //-------------------------------------------------------------------
  //  OldSpellingTemplate_0 = SEP TextualTParam
  //-------------------------------------------------------------------
  private boolean OldSpellingTemplate_0()
    {
      begin("");
