...
package wiktiopeggynary.parser.mouse;
...
public class ParserBase implements wiktiopeggynary.parser.mouse.CurrentRule
{
  //-------------------------------------------------------------------
  //  Input
  //-------------------------------------------------------------------
  ...
  //  Semantics (base)
  //-------------------------------------------------------------------
  protected wiktiopeggynary.parser.mouse.SemanticsBase sem;
