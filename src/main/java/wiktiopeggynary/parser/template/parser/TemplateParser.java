//=========================================================================
//
//  This file was generated by Mouse 1.7 at 2016-05-29 17:37:50 GMT
//  from grammar
...
public class TemplateParser extends wiktiopeggynary.parser.mouse.ParserBase
{
  ...
  //-------------------------------------------------------------------
  //  TCallParamName_1 = !(EQ / SEP / RF)
  //-------------------------------------------------------------------
  private boolean TCallParamName_1()
    {
      begin("","not EQ / SEP / RF");
      if (TCallParamName_2()) return rejectPred();
      return acceptPred();
    }
  
  //-------------------------------------------------------------------
  //  TCallParamName_2 = EQ / SEP / RF
  //-------------------------------------------------------------------
  private boolean TCallParamName_2()
    {
      begin("");
      if (EQ()) return acceptInner();
      if (SEP()) return acceptInner();
