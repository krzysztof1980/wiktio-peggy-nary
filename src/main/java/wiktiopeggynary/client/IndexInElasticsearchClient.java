package wiktiopeggynary.client;
 ...
 */
public class IndexInElasticsearchClient {

    public static final String INDEX = "dewiktionary";
    public static final String TYPE = "page";

    private static final Logger logger = LoggerFactory.getLogger(IndexInElasticsearchClient.class);
    ...
    public IndexInElasticsearchClient() {
    ...
    public void indexWiktionaryPage(WiktionaryEntry wiktionaryEntry) {
        try {
            bulkProcessor.add(
                    new IndexRequest(INDEX, TYPE, UUID.randomUUID().toString())
                            .opType(IndexRequest.OpType.CREATE)
                            .source(objectMapper.writeValueAsBytes(wiktionaryEntry)));
